...
function extensions() = object(
    med_12_apauto   = object( h=126, h1=22, h2=5.0, h3=15, d1=23, w=13 ),
    short_38_dewalt = object( h= 75, h1=18, h2=6.0, h3=10, d1=17, w=10 ),
    short_38_hf     = object( h= 75, h1=16, h2=4.0, h3=12, d1=17, w=10 ),
    med_38_hf       = object( h= 75, h1=60, h2=2.6, h3=10, d1=17, w=10 ),
);
...
function socket_sets() = object(
    sae_shallow_38 = base_38_set,
    sae_deep_38    = object( base_38_set,
        offset      = [-6,-27,3.35],
        depth       = 63.7,
        flip_labels = true,
        z           = 21.35
    ),
    mm_shallow_38  = object( base_38_set,
        offset=[ -3, 58, 20 ],
        labels=[ "10mm","11mm","12mm", "13mm", "14mm", "15mm", "16mm", "17mm", "19mm", "22mm" ],
    ),
    mm_deep_38     = object( base_38_set,
        offset=[ -6, 77, 3.35],
        depth       = 63.7,
        z           = 21.35,
        flip_labels = true,
        labels      = [ "10mm", "11mm", "12mm", "13mm", "14mm", "15mm", "16mm", "17mm", "19mm", "21mm" ],
        sizes       = [   16.8,   16.8,   16.8,   17.8,   19.8,   21.8,   21.8,   23.8,   25.8,   27.6 ]
    )
);
